...
if($_REQUEST['act'] == 'get_family_healthy')
{
    ...
    $sql_select = 'SELECT user_name FROM '.$GLOBALS['ecs']->table('users')
    ...
    $sql_select = 'SELECT COUNT(*) FROM ' .$GLOBALS['ecs']->table('weight_condition')
        ." WHERE user_id=$user_id";
    ...
    $sql_select = 'SELECT * FROM '
        .$GLOBALS['ecs']->table('weight_condition')
...
elseif($_REQUEST['act'] == 'del_family_user')
{
    ...
    $sql_del = 'UPDATE '.$GLOBALS['ecs']->table('user_family_member').
        " SET status=1 WHERE user_id='$user_id'";
...
elseif ($_REQUEST['act'] == 'get_history_healthy')
{
    ...
    $sql_select = 'SELECT examination_name,descript FROM '
        .$GLOBALS['ecs']->table('examination')
