...
if ($_REQUEST['act'] == '')
{
    ...
    $hello       = "{$_SESSION['admin_name']},您好!  今天是".date('Y-m-d',time()).' 星期'.$weekarr[date('w',time())];

    $smarty->assign('hello',$hello); $smarty->assign('pwd_info',$stats_info['pwd_info']);
    ...
    if($_REQUEST['from_sel']){
        ...
        $smarty->assign('task_progress',get_task_progress());
        ...
        $smarty->assign('task_progress',$smarty->fetch('index_task_progress.htm'));
