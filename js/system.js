...
function allotAuthority(){
  if(document.getElementById('admin_view').innerHTML == ''){
...
function switchRole(obj){
  ...
  for (var i = 0; i < length; i++) {
    document.getElementById('role_'+obj.options[i].value).className = 'hide';
  }

  document.getElementById('role_'+obj.value).className = 'show';
}
